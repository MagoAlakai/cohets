var Cohete = /** @class */ (function () {
    ...
    Cohete.prototype.acelerar = function () {
        ...
        if (this.getPotenciaActual() < this.getPotenciaMax()) {
            ...
            alert("Ha acelerado el cohete " + this.getId().toUpperCase() + ". Su potencia actual es de " + this.getPotenciaActual());
        }
        else {
    ...
    Cohete.prototype.frenar = function () {
        ...
        if (this.getPotenciaActual() !== 0) {
            ...
            alert("Ha frenado el cohete " + this.getId().toUpperCase() + ". Su potencia actual es de " + this.getPotenciaActual());
        }
        else {
